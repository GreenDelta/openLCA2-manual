...
| **Consistency check**                          | - Consistent use of physical units, conversion factors, and flow properties <br> - Same allocation rules and numerical cut-off throughout the product system <br> - "Parameter Sets" for scenario consistency <br> - Data Quality analysis to assess regional/temporal representativeness <br> |
