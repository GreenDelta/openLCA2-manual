...
## 25.09.2026
- New section about [Migration](./migration.md) between database versions (updating the background data)
- New section about [API Clients](./advanced_top/api_clients.md) in openLCA
- Updated [Importing databases](databases/importing_and_combining_databases.md) and [Exporting databases](databases/exporting_databases.md) chapter
